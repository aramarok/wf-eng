...
import xflow.server.controller.handler.*;
...
public class RequestHandlerFactory {
  ...
  private void register(Class aClass, Class handler) {
     registeredHandlers.put( aClass, Persistence.enhanceInstanceOfClass( handler ) );
  }



  public RequestHandler getHandlerFor( Request r ){
    RequestHandler rh = (RequestHandler) registeredHandlers.get( r.getClass() );
    ...
    if( rh == null ) {
      log.info( "Handler for " + r.getClass().getName() + " should be defined at this point!!");
    }
    return rh;
  }
