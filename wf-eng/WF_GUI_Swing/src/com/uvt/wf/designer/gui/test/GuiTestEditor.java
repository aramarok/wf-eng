package com.uvt.wf.designer.gui.test;
...
public class GuiTestEditor extends JApplet implements GraphSelectionListener,
		KeyListener {
	...
	public static void main(String[] args) {
		...
		// Add an Editor Panel
		frame.getContentPane().add(new GuiTestEditor());
		// Fetch URL to Icon Resource
		URL jgraphUrl = GuiTestEditor.class.getClassLoader().getResource(
