...
public class Admin {
	...
	List v = WorkflowManager.getActiveWorkflows(this.getUSER());
	return v;
    }

    @SuppressWarnings("unchecked")
    public List getKnownWorkflows() throws ExceptieWF {
	List v = WorkflowManager.getWorkflowModels(this.getUSER());
	return v;
    }
	...
	StareWF state = WorkflowManager.getWorkflowState(new Integer(wfid),
		this.getUSER());
	return state;
    }
